 ...
 * @param {PrinterDropdown} o.clearDropdown - The dropdown object managing the Clear printer.
...
function configureManager({
  mgr,
  clearDropdown = new PrinterDropdown(PrinterDropdown.getElementsOnPage("adult", document)),
  minorDropdown = new PrinterDropdown(PrinterDropdown.getElementsOnPage("minor", document)),
  nav = navigator,
} = {}) {
  mgr = mgr || new PrinterManager(nav, clearDropdown, minorDropdown);
  return mgr;
}
